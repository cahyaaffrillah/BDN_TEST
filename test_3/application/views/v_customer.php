                   ...
                   <a class="btn btn-xs default" href="javascript:;" id="form_act">
                    ...
                    <input type="hidden" name="id_customer" id="id_customer" value=""/>
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                                ...
                                                <tr>
                                                   <td colspan="6" style="font-weight:bold"> Detail Customer </td>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td width="10px"> : </td>
                                                    <td>  <input type="text" class="form-control" name="name" id="name" tabindex="1"> </td>
                                                ...
                                                <tr>
                                                   <td width="150px"> Email  </td>
                                                    <td width="10px"> : </td>
                                                    <td>  <input type="email" class="form-control" name="email" id="email" tabindex="1"> </td>
                                                </tr>
                                                <tr>
                                                    <td width="150px"> Phone  </td>
                                                    <td width="10px"> : </td>
                                                    <td>  <input type="text" class="form-control" name="phone" id="phone" tabindex="1"> </td>
                                                </tr>
                                                <tr>
                                                    <td width="150px"> Password  </td>
                                                    <td width="10px"> : </td>
                                                    <td>  <input type="password" class="form-control" name="password" id="password" tabindex="1"> </td>
                                                </tr>
                                                 <tr>
                                                    <td width="150px">Konfirmasi Password  </td>
                                                    <td width="10px"> : </td>
                                                    <td>  <input type="password" class="form-control" name="password_2" id="password_2" tabindex="1"> </td>
                                                </tr>
  ...
  var initTable1 = function() {
    ...
    */
    ...
    var oTable = $(target).dataTable( {
        ...
        "sAjaxSource": "<?php echo base_url(); ?>c_customer/view", // define ajax source URL
        "sServerMethod": "POST"
      });
...
function set_val(data) {
  // body...
   ...
   $.post('<?php echo base_url()?>c_customer/dataedit', {id_customer: data}, function(respond) {  
                  
                  $("#id_customer").val(respond[0].id_customer);
                 
                  $("#name").val(respond[0].name);
                  $("#item_description").val(respond[0].item_description);
                
                  $("#phone").val(respond[0].phone);
...
function set_del(data) {
  if( confirm("Apakah data ingin dihapus ?") ){
    $.ajax({
                type: 'POST',
                url: '<?php echo base_url() ?>c_customer/delete',
                data: { id : data },
                success: function(data) {
                    if(data === 'true')
                    // $('#cancel').click();
