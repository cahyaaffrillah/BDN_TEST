                   ...
                   <a class="btn btn-xs default" href="javascript:;" id="form_act">
                    ...
                    <input type="hidden" name="id_item" id="id_item" value=""/>
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                                ...
                                                <tr>
                                                   <td colspan="6" style="font-weight:bold"> Detail Item </td>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td width="10px"> : </td>
                                                    <td>  <input type="text" class="form-control" name="item_name" id="item_name" tabindex="1"> </td>
                                                   
                                                   
                                                </tr> 
                                                <tr>
                                                   <td width="150px"> Deskripsi Item  </td>
                                                    <td width="10px"> : </td>
                                                    <td>  <input type="text" class="form-control" name="item_description" id="item_description" tabindex="1"> </td>
                                                </tr>
                                                <tr>
                                                    <td width="150px"> Harga  </td>
                                                    <td width="10px"> : </td>
                                                    <td>  <input type="number" class="form-control" name="item_price" id="item_price" tabindex="1"> </td>
                                                </tr>
  ...
  var initTable1 = function() {
    ...
    */
    ...
    var oTable = $(target).dataTable( {
        ...
        "sAjaxSource": "<?php echo base_url(); ?>c_item/view", // define ajax source URL
        "sServerMethod": "POST"
      });
...
function set_val(data) {
  // body...
   ...
   $.post('<?php echo base_url()?>c_item/dataedit', {id_item: data}, function(respond) {  
                  
                  $("#id_item").val(respond[0].id_item);
                 
                  $("#item_name").val(respond[0].item_name);
                  $("#item_description").val(respond[0].item_description);
                
                  $("#item_price").val(respond[0].item_price);
...
function set_del(data) {
  if( confirm("Apakah data ingin dihapus ?") ){
    $.ajax({
                type: 'POST',
                url: '<?php echo base_url() ?>c_item/delete',
                data: { id : data },
                success: function(data) {
                    if(data === 'true')
                    // $('#cancel').click();
