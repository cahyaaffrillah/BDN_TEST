                              ...
                              <div class="panel-heading">
                                  <h4 class="panel-title">
                                      <a class="accordion-toggle" data-toggle="collapse" data-parent="#" href="#collapse">
                                         Write a query to list the cheapest admin fee for each payment channel. In case of the same admin fee, separate the payment provider with comma. The result must contain:
                              ...
                              <div id="collapse" class="panel-collapse in" style="height: auto;">
                                  <div class="panel-body">
                                     <table class="table table-bordered">
                                       <thead>
                                         <th>payment_channel_code</th>
                                         <th>cheapest admin_fee</th>
                                         <th>cheapest payment_provider</th>
                                       ...
                                       <tbody>
                                           ...
                                           <td><?php echo $j->admin_fee?></td>
                                           <td><?php echo $j->payment_provider?></td>
                                           </tr>
                                           <?php }?>
