                   ...
                   <a class="btn btn-xs default" href="javascript:;" id="form_act">
                    ...
                    <input type="hidden" name="id_channel" id="id_channel" value=""/>
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                                ...
                                                <tr>
                                                   <td colspan="6" style="font-weight:bold"> Detail Channel  </td>
  ...
  var initTable1 = function() {
    ...
    */
    ...
    var oTable = $(target).dataTable( {
        ...
        "sAjaxSource": "<?php echo base_url(); ?>c_channel/view", // define ajax source URL
        "sServerMethod": "POST"
      });
...
function set_val(data) {
  // body...
   ...
   $.post('<?php echo base_url()?>c_channel/dataedit', {id_channel: data}, function(respond) {  
...
function set_del(data) {
  if( confirm("Apakah data ingin dihapus ?") ){
    $.ajax({
                type: 'POST',
                url: '<?php echo base_url() ?>c_channel/delete',
                data: { id : data },
                success: function(data) {
                    if(data === 'true')
                    // $('#cancel').click();
